...
class FrameworkConfig implements \Symfony\Component\Config\Builder\ConfigBuilderInterface
{
    ...
    */
     ...
     * @default {"enabled":false,"paths":[],"excluded_patterns":[],"server":false,"public_prefix":"\/assets\/","missing_import_mode":"warn","extensions":[],"importmap_path":"%kernel.project_dir%\/importmap.php","importmap_polyfill":null,"importmap_script_attributes":[],"vendor_dir":"%kernel.project_dir%\/assets\/vendor","provider":"jsdelivr.esm"}
